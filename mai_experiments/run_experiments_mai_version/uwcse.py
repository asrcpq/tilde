...
dlogic = os.path.join(droot, test_name, dlogic_relative)
dfold = os.path.join(droot, test_name, dfold_relative)
doutput = os.path.join(droot, test_name, dout_relative)

# --- file names ---
fname_examples = os.path.join(dlogic, logic_name + kb_suffix)
fname_settings = os.path.join(dlogic, logic_name + s_suffix)
fname_background = os.path.join(dlogic, logic_name + bg_suffix)
