...
from mai_version.trees.TILDEQueryScorer import QueryScoreInfo, TILDEQueryScorer, TILDEQueryScorer2
...
from mai_version.representation.example import calculate_majority_class, calculate_label_frequencies_and_absolute_counts, \
	ExampleWrapper, Label

from mai_version.trees.TreeBuilder_helper import print_partition_subset_sizes
from mai_version.trees.TreeBuilder_helper_probabilistic import print_partition_statistics_prob, \
	create_probabilistic_leaf_node
from mai_version.trees.TreeNode import TreeNode
from mai_version.trees.leaf_strategy import DeterministicLeafStrategy, MLEDeterministicLeafStrategy
from mai_version.trees.stop_criterion import StopCriterionHandler, StopCriterionMinimalCoverage
...
class TreeBuilder:
	...
	def get_tree(self) -> TreeNode:
		...
		self.example_partitioner.print_statistics()

		if self.example_partitioner.nb_of_times_statistics_printed == 10:
			ExamplePartitioner.print_statistic_lists()
