...
from mai_version.probeersel.mach_tests import labeled_examples, background_knowledge, possible_targets, language_machines

import mai_version.classification
...
for q in refined_queries:
	...
	score = mai_version.trees.scoring.information_gain(examples_set, examples_satisfying_query, examples_set - examples_satisfying_query, possible_targets)
